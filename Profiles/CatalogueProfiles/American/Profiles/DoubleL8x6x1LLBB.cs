...
{
    public sealed class DoubleL8x6x1LLBB : SingletonAmericanBase<DoubleL8x6x1LLBB>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L8X6X1LLBB";
