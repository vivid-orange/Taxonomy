...
{
    public sealed class DoubleL8x8x1x3over4 : SingletonAmericanBase<DoubleL8x8x1x3over4>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L8X8X1X3/4";
