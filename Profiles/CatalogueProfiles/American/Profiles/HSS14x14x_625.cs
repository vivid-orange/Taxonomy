...
{
    public sealed class HSS14x14x_625 : SingletonAmericanBase<HSS14x14x_625>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS14X14X.625";
        ...
        public Length FlatWidth => new Length(12.30, LengthUnit.Inch);
        public Length Thickness => new Length(0.63, LengthUnit.Inch);

        public HSS14x14x_625() { }
    }
}
