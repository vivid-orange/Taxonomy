...
{
    public sealed class HSS16x16x_500 : SingletonAmericanBase<HSS16x16x_500>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS16X16X.500";
        ...
        public Length FlatWidth => new Length(14.60, LengthUnit.Inch);
        public Length Thickness => new Length(0.50, LengthUnit.Inch);

        public HSS16x16x_500() { }
    }
}
