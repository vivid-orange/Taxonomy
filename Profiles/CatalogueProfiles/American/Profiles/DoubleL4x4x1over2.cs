...
{
    public sealed class DoubleL4x4x1over2 : SingletonAmericanBase<DoubleL4x4x1over2>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L4X4X1/2";
