...
{
    public sealed class HSS9x9x_188 : SingletonAmericanBase<HSS9x9x_188>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS9X9X.188";
        ...
        public Length FlatWidth => new Length(8.48, LengthUnit.Inch);
