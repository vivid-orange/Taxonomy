...
{
    public sealed class DoubleL5x3x3over8LLBB : SingletonAmericanBase<DoubleL5x3x3over8LLBB>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L5X3X3/8LLBB";
