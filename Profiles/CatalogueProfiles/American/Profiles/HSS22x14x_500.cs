...
{
    public sealed class HSS22x14x_500 : SingletonAmericanBase<HSS22x14x_500>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS22X14X.500";
        ...
        public Length FlatWidth => new Length(12.6, LengthUnit.Inch);
        public Length Thickness => new Length(0.50, LengthUnit.Inch);

        public HSS22x14x_500() { }
    }
}
