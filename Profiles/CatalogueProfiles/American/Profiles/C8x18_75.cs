...
{
    public sealed class C8x18_75 : SingletonAmericanBase<C8x18_75>, IChannelTaperFlange
    {
        public override AmericanShape Shape => AmericanShape.C;
        public override string Label => "C8X18.75";
        public Length Height => new Length(8.00, LengthUnit.Inch);
        public Length Width => new Length(2.53, LengthUnit.Inch);
