...
{
    public sealed class C5x6_7 : SingletonAmericanBase<C5x6_7>, IChannelTaperFlange
    {
        public override AmericanShape Shape => AmericanShape.C;
        public override string Label => "C5X6.7";
        public Length Height => new Length(5.00, LengthUnit.Inch);
        public Length Width => new Length(1.75, LengthUnit.Inch);
