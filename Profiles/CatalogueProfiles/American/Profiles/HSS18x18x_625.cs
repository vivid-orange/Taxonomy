...
{
    public sealed class HSS18x18x_625 : SingletonAmericanBase<HSS18x18x_625>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS18X18X.625";
        ...
        public Length FlatWidth => new Length(16.30, LengthUnit.Inch);
        public Length Thickness => new Length(0.63, LengthUnit.Inch);

        public HSS18x18x_625() { }
    }
}
