...
{
    public sealed class DoubleL4x4x3over8 : SingletonAmericanBase<DoubleL4x4x3over8>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L4X4X3/8";
