...
{
    public sealed class S24x106 : SingletonAmericanBase<S24x106>, IITaperFlange
    {
        public override AmericanShape Shape => AmericanShape.S;
        public override string Label => "S24X106";
        ...
        public Length ToeRadius => new Length(0.546, LengthUnit.Inch);
