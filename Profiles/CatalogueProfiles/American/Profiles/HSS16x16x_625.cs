...
{
    public sealed class HSS16x16x_625 : SingletonAmericanBase<HSS16x16x_625>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS16X16X.625";
        ...
        public Length FlatWidth => new Length(14.30, LengthUnit.Inch);
        public Length Thickness => new Length(0.63, LengthUnit.Inch);

        public HSS16x16x_625() { }
    }
}
