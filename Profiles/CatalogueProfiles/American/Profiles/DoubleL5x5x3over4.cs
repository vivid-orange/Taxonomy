...
{
    public sealed class DoubleL5x5x3over4 : SingletonAmericanBase<DoubleL5x5x3over4>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L5X5X3/4";
