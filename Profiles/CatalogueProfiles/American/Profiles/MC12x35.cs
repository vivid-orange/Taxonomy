...
{
    public sealed class MC12x35 : SingletonAmericanBase<MC12x35>, IChannelTaperFlange
    {
        public override AmericanShape Shape => AmericanShape.MC;
        public override string Label => "MC12X35";
        public Length Height => new Length(12.00, LengthUnit.Inch);
        public Length Width => new Length(3.77, LengthUnit.Inch);
