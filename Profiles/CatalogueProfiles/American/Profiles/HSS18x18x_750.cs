...
{
    public sealed class HSS18x18x_750 : SingletonAmericanBase<HSS18x18x_750>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS18X18X.750";
        ...
        public Length FlatWidth => new Length(15.90, LengthUnit.Inch);
        public Length Thickness => new Length(0.75, LengthUnit.Inch);

        public HSS18x18x_750() { }
    }
}
