...
{
    public sealed class HSS14x12x_500 : SingletonAmericanBase<HSS14x12x_500>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS14X12X.500";
        ...
        public Length FlatWidth => new Length(10.6, LengthUnit.Inch);
        public Length Thickness => new Length(0.50, LengthUnit.Inch);

        public HSS14x12x_500() { }
    }
}
