...
{
    public sealed class C7x12_25 : SingletonAmericanBase<C7x12_25>, IChannelTaperFlange
    {
        public override AmericanShape Shape => AmericanShape.C;
        public override string Label => "C7X12.25";
        public Length Height => new Length(7.00, LengthUnit.Inch);
        public Length Width => new Length(2.19, LengthUnit.Inch);
