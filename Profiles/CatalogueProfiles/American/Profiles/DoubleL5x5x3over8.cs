...
{
    public sealed class DoubleL5x5x3over8 : SingletonAmericanBase<DoubleL5x5x3over8>, IDoubleAngle
    {
        public override AmericanShape Shape => AmericanShape.DoubleL;
        public override string Label => "2L5X5X3/8";
