...
{
    public sealed class HSS12x12x_188 : SingletonAmericanBase<HSS12x12x_188>, IRoundedRectangularHollow
    {
        public override AmericanShape Shape => AmericanShape.HSS;
        public override string Label => "HSS12X12X.188";
        ...
        public Length FlatWidth => new Length(11.50, LengthUnit.Inch);
        public Length Thickness => new Length(0.19, LengthUnit.Inch);

        public HSS12x12x_188() { }
    }
}
