...
namespace ProfileTests
{
    public class AutomatedTests
    {
        ...
        public void DeserializeTest(Type type)
        {
            ...
            {
                object[] args = CreateConstructorArguments(constructor);
                IProfile instance = (IProfile)constructor.Invoke(args);
                Assert.NotNull(instance);
        ...
        public class TestDataGenerator : IEnumerable<object[]>
        {
            ...
            private static List<object[]> GetAllComponents()
            {
                ...
                Type[] typelist = Assembly.GetAssembly(typeof(Angle)).GetTypes();
        ...
        private void TestObjectsSurvivesJsonRoundtrip<T>(T obj) where T : IProfile
        {
        ...
        private void TestPropertiesInObjectsAreEqual<T>(T expected, T actual) where T : IProfile
        {
