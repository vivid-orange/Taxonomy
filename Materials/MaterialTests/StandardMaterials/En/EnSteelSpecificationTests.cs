...
namespace MaterialTests.StandardMaterials.En
{
    public class EnSteelSpecificationTests
    {
        ...
        public void CreateSpecificationTests()
        {
            ...
            Assert.Equal(EnSteelQualityClass.None, spec.QualityClass);
        }
        ...
        public void EditSpecificationTests()
        {
            ...
            spec.QualityClass = EnSteelQualityClass.JR;
            ...
            Assert.Equal(EnSteelQualityClass.JR, spec.QualityClass);
        }


        [Theory]
        [InlineData("S235", EnSteelGrade.S235,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S275J0", EnSteelGrade.S275,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.J0)]
        [InlineData("S355JR", EnSteelGrade.S355,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.JR)]
        [InlineData("S450J2", EnSteelGrade.S450,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.J2)]
        [InlineData("S275K2 N", EnSteelGrade.S275,
            EnSteelDeliveryCondition.N, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.K2)]
        [InlineData("S275 NL", EnSteelGrade.S275,
            EnSteelDeliveryCondition.N, false, EnSteelImpactTemperatureProperty.L, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S355 N", EnSteelGrade.S355,
            EnSteelDeliveryCondition.N, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        ...
        [InlineData("S275 M", EnSteelGrade.S275,
            EnSteelDeliveryCondition.M, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S275 ML", EnSteelGrade.S275,
            EnSteelDeliveryCondition.M, false, EnSteelImpactTemperatureProperty.L, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        ...
        [InlineData("S235 W", EnSteelGrade.S235,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.W, EnSteelQualityClass.None)]
        [InlineData("S355 W", EnSteelGrade.S355,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.W, EnSteelQualityClass.None)]
        [InlineData("S355 WP", EnSteelGrade.S355,
            EnSteelDeliveryCondition.AR, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.WP, EnSteelQualityClass.None)]
        [InlineData("S460 Q", EnSteelGrade.S460,
            EnSteelDeliveryCondition.Q, false, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S460 QL", EnSteelGrade.S460,
            EnSteelDeliveryCondition.Q, false, EnSteelImpactTemperatureProperty.L, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S460 QL1", EnSteelGrade.S460,
            EnSteelDeliveryCondition.Q, false, EnSteelImpactTemperatureProperty.L1, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S235H", EnSteelGrade.S235,
            EnSteelDeliveryCondition.AR, true, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S275H", EnSteelGrade.S275,
            EnSteelDeliveryCondition.AR, true, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S355H", EnSteelGrade.S355,
            EnSteelDeliveryCondition.AR, true, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S275NH", EnSteelGrade.S275,
            EnSteelDeliveryCondition.N, true, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S275NHL", EnSteelGrade.S275,
            EnSteelDeliveryCondition.N, true, EnSteelImpactTemperatureProperty.L, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        ...
        [InlineData("S275MH", EnSteelGrade.S275,
            EnSteelDeliveryCondition.M, true, EnSteelImpactTemperatureProperty.None, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        [InlineData("S275MHL", EnSteelGrade.S275,
            EnSteelDeliveryCondition.M, true, EnSteelImpactTemperatureProperty.L, EnSteelCorrosionResistance.None, EnSteelQualityClass.None)]
        ...
        public void SpecificationFromDesignationTests(string steelDesignation, EnSteelGrade expGrade,
            ...
            EnSteelCorrosionResistance expCorr, EnSteelQualityClass expQuality)
        {
            // Assemble
            NationalAnnex nationalAnnex = NationalAnnex.UnitedKingdom;
            ...
            Assert.Equal(expQuality, spec.QualityClass);
        }
