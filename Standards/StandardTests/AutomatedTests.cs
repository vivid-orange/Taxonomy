...
namespace StandardTests
{
    public class AutomatedTests
    {
        ...
        public void DeserializeTest(Type type)
        {
            ...
            {
                object[] args = CreateConstructorArguments(constructor);
                IStandard instance = (IStandard)constructor.Invoke(args);
                Assert.NotNull(instance);
        ...
        private void TestObjectsSurvivesJsonRoundtrip<T>(T obj) where T : IStandard
        {
        ...
        private void TestPropertiesInObjectsAreEqual<T>(T expected, T actual) where T : IStandard
        {
